...
namespace HeroPecApp
{
    ...
    public class ToggleSwitch : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Pen penToggleHolder = new Pen(Color.DarkGray, 1.55f);
        ...
        private void UpdateSize()
        {
            ...
            Width = ToogleSwitchWidth + size.Width + 6;
        }
        ...
        /// </summary>
        class ControlDesignerEx : System.Windows.Forms.Design.ControlDesigner
        {
